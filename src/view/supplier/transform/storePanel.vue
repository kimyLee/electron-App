<template>
    ...
    <el-col :span="6">
        <div class="my-panel" style="padding: 0">
            ...
            <my-input text="备注" v-model="note" id="trans_note"></my-input>
            <my-input text="前存金额" v-model="trans_before" id="fee_money" next="fee_note" pre="!fee_id" disable></my-input>
            <my-input text="转后金额" v-model="trans_after" id="fee_note" next="fee_sure" pre="fee_money"></my-input>
            <div class="btn-panel">
                <div class="btnItem"
