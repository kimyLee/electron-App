<template>
    ...
    <el-col :span="6">
        <div class="my-panel" style="padding: 0">
            ...
            <my-input text="还款金额" v-model="money" id="cus_money" next="cus_note" pre="!cus_id"></my-input>
    ...
    methods: {
      ...
      addMoney () {
        ...
        const callback = (res, msg) => {
          if (res.ret === 0) {
            alert(msg)
            bus.$emit('getReturnMoney', this.cus_id)
            this.clearData()
            this.goTarget('!cus_id')
          }
        }
        api.borrowMoney({
          cId: this.cus_id,
