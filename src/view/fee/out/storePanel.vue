<template>
  ...
  <el-col :span="6">
    <div class="my-panel" style="padding: 0">
      <div class="my-panel-header">支出管理</div>
      <my-input text="支出备注" v-model="remark" id="in_remark" next="in_money"></my-input>
      <my-input text="支出金额" v-model="money" id="in_money" next="btn" pre="in_remark"></my-input>
      <div class="btn-panel">
        <div class="btnItem"
